            ...
            {currentUser === editingEvent.userId ? (
              <>
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-2">
                  ...
                  <button
                    className={`px-3 sm:px-4 py-2 rounded-3xl text-white transition-colors text-sm sm:text-base order-1 sm:order-2 ${
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-2">
              ...
              >
                Cancel
                            ...
                            <button 
                                className={`px-4 py-2 rounded-3xl text-white transition-colors ${
                                    newEventTitle.trim() 
                                        ? 'bg-blue-500 hover:bg-blue-600' 
                                        : 'bg-gray-400 cursor-not-allowed'
                                }`}
